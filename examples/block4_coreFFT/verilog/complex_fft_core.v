...
// =========================================================================
    ...
    assign wm_wr_en   = (state == S_LOAD_DATA)  ? load_wr_en   : sc_wr_en;
    assign wm_wr_addr = (state == S_LOAD_DATA)  ? load_wr_addr : sc_wr_addr;
    assign wm_wr_data = (state == S_LOAD_DATA)  ? load_wr_data : sc_wr_data;
    ...
    always @(posedge clk or negedge rst_n) begin
        if (!rst_n) begin
            ...
            case (state)
                ...
                // Latencia 1 ciclo de BSRAM: out_rd_addr presentado en
                // ciclo N → dato disponible en ciclo N+1.
                // fft_valid=1 durante los N_COMPLEX ciclos de salida.
